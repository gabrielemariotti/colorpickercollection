...
import it.gmariotti.android.example.colorpicker.dashclockpicker.ColorDialogFragmentSA;
import it.gmariotti.android.example.colorpicker.dashclockpicker.SettingsActivity;
import it.gmariotti.android.example.colorpicker.dashclockpicker.ColorPreference.ColorDialogFragment;
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		case 2:
			...
			ColorPickerDialog colorcalendar = ColorPickerDialog.newInstance(R.string.color_picker_default_title,
																			mColor, 0, 5, Utils.isTablet(this)? ColorPickerDialog.SIZE_LARGE : ColorPickerDialog.SIZE_SMALL);
